...
|---|---|---|
| **[AI phone receptionist](./projects/voice-receptionist/)**: Vapi voice agent (German and English), FastAPI tool webhook for availability and bookings, AI disclosure (EU AI Act Art. 50) and recording consent (§201 StGB) at the start of every call, hash-chained evidence record per call | Deployed. Demo on request | [12/12 golden calls, 2026-09-02](./evals/2026-09-02-voice-receptionist-eval.json) |
