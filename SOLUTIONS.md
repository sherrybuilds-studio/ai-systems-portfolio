...
| 8 | **Campaigns / broadcasts** | Segmented WhatsApp broadcasts to an opted-in customer list | `apps/restaurant-bot/automations/broadcast.py` (public: [restaurant-bot-ai](https://github.com/sherrybuilds-studio/restaurant-bot-ai)) | Built |
